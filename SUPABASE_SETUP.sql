-- สร้างตาราง phone_numbers สำหรับเก็บข้อมูลเบอร์มือถือ
...
(
  '081-234-5678', 'AIS', 'งาน', 'เน็ต 20GB', 399,
  '2024-01-15', '2024-02-14', '2025-01-15', 'active', 'เบอร์หลัก'
),
(
  '082-345-6789', 'DTAC', 'ส่วนตัว', 'โทรไม่อั้น', 299,
  '2023-12-28', '2024-01-27', '2024-12-28', 'active', 'เบอร์สำรอง'
),
(
  '083-456-7890', 'TRUE', 'ธุรกิจ', 'เน็ต 10GB', 159,
  '2023-12-20', '2024-01-19', '2023-12-20', 'expired', 'ไม่ได้ใช้แล้ว'
);
